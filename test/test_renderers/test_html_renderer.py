...
class TestHTMLRenderer(TestRenderer):
    ...
    def test_raw_text(self):
        self._test_token(
            "RawText", "john &amp; jane", children=False, content="john & jane"
        )

    def test_html_span(self):
        self._test_token(
            "HTMLSpan", "<some>text</some>", children=False, content="<some>text</some>"
        )
    ...
    def test_html_block(self):
        ...
        self._test_token("HTMLBlock", output, children=False, content=content)
